...
var _assetFilesystems = map[string]*_assetfs{
	`static`: &_assetfs{
		data: [][]byte{
			[]byte("<!doctype html>\n<title>Served with assetfs</title>\n<p>This page is served via assetfs http.FileSystem interface\n<p>See what's inside <a href=/subdir/>subdirectory</a>.\n"),
			[]byte("Surprise!\n"),
		},
		meta: []_itemMetadata{
			{name: `index.html`, mode: 0644, mtime: 1449161677000000000, size: 168},
			{name: `foo`, mode: 0644, mtime: 1449161710000000000, size: 10},
			{name: `static`, mode: 020000000755, mtime: 1449161681000000000, isDir: true, children: []int{0, 3}},
			{name: `subdir`, mode: 020000000755, mtime: 1449161851000000000, isDir: true, children: []int{1, 4}},
			{name: `empty_dir`, mode: 020000000755, mtime: 1449135503000000000, isDir: true},
		},
